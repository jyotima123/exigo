        ...
        <div class="container">
            <div class="row">
                        ...
                        <li>
                            ...
                            <div class="calander-ctrl">
                                <span class="v-btn v-btn-primary mr-1" data-toggle="tooltip" data-placement="top" title="Click for previous month"><i class="fa fa-angle-double-left"></i></span>
                                    <input type="text" class="form-control mr-1 datepicker" >
                                <span data-toggle="tooltip" data-placement="top" title="Click for next month" class="v-btn v-btn-primary" ><i class="fa fa-angle-double-right"></i></span>
                            </div>
                        </li>
                        <li>
                ...
                <div class="col-md-4 text-md-right align-self-center">
                    <p>  <label for="">Download files</label></p>
